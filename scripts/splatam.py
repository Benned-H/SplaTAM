...
def rgbd_slam(config: dict):
    ...
    if seperate_densification_res:
        ...
        params, variables, intrinsics, first_frame_w2c, cam, densify_intrinsics, densify_cam = (
    ...
    if config["load_checkpoint"]:
        ...
        params = {
            k: torch.tensor(params[k]).cuda().float().requires_grad_(True) for k in params.keys()
        }
