...
def rgbd_slam(config: dict):
    ...
    params, variables, optimizer, intrinsics, w2c, cam = initialize_first_timestep_from_ckpt(
        ckpt_path,
        mapping_dataset,
        num_frames,
    ...
    for time_idx in tqdm(range(num_frames)):
        ...
        if config["use_wandb"]:
            wandb_run.log({"Init/Number of Gaussians": post_num_pts, "Init/step": wandb_time_step})
